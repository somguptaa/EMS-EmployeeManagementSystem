...
public class ManagerController {
	...
	@ApiResponses({ @ApiResponse(responseCode = "201", description = "Manager Created Successfully"),
	...
	public ResponseEntity<ResponseMessageDto> createNewManager(@RequestBody Manager manager) {
		...
		ResponseMessageDto response = new ResponseMessageDto(201, "SUCCESS", "Manager created successfully", saved);
	...
	public ResponseEntity<ResponseMessageDto> getAllManagers() {
		...
		ResponseMessageDto response = new ResponseMessageDto(200, "Managers fetched successfully", managers);
	...
	public ResponseEntity<ResponseMessageDto> getManagerById(@PathVariable Long id) {
		...
		ResponseMessageDto response = new ResponseMessageDto(200, "SUCCESS", "Manager fetched successfully", manager);
	...
	public ResponseEntity<ResponseMessageDto> updateManager(@PathVariable Long id, @RequestBody Manager manager) {
		...
		if (updated == null) {
			...
			return ResponseEntity.status(HttpStatus.NOT_FOUND).body(new ResponseMessageDto(404, "Manager not found"));
		}

		logger.info("SUCCESS: Manager Updated with ID: {}", id);

		ResponseMessageDto response = new ResponseMessageDto(200, "SUCCESS", "Manager updated successfully", updated);
	...
	public ResponseEntity<ResponseMessageDto> deleteManager(@PathVariable Long id) {
		...
		ResponseMessageDto response = new ResponseMessageDto(200, "SUCCESS", "Manager deleted successfully", null);
	...
	public ResponseEntity<ResponseMessageDto> deleteAllManagers() {
		...
		ResponseMessageDto response = new ResponseMessageDto(200, "SUCCESS", "All Managers deleted successfully", null);
